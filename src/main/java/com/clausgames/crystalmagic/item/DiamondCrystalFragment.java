...
public class DiamondCrystalFragment extends OreCrystalFragment
{
    ...
    {
        super(ModBlocks.diamondCrystalPlant, ModBlocks.diamondInfusedStone); //blockPlant, blockSoil
        this.blockPlant = ModBlocks.diamondCrystalPlant;
        this.blockSoil = ModBlocks.diamondInfusedStone;
