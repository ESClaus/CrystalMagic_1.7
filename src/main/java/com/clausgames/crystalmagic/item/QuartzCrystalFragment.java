...
public class QuartzCrystalFragment extends OreCrystalFragment
{
    ...
    {
        super(ModBlocks.quartzCrystalPlant, ModBlocks.quartzInfusedStone); //blockPlant, blockSoil
        this.blockPlant = ModBlocks.quartzCrystalPlant;
        this.blockSoil = ModBlocks.quartzInfusedStone;
