...
public class RedstoneCrystalFragment extends OreCrystalFragment
{
    ...
    {
        super(ModBlocks.redstoneCrystalPlant, ModBlocks.redstoneInfusedStone); //blockPlant, blockSoil
        this.blockPlant = ModBlocks.redstoneCrystalPlant;
        this.blockSoil = ModBlocks.redstoneInfusedStone;
