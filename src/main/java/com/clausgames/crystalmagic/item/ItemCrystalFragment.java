...
public class ItemCrystalFragment extends OreCrystalFragment
{
    ...
    {
        super(ModBlocks.crystalPlant, ModBlocks.crystalInfusedStone); //blockPlant, blockSoil
        this.blockPlant = ModBlocks.crystalPlant;
        this.blockSoil = ModBlocks.crystalInfusedStone;
