...
public class SocketStationCraftingManager
{
    /** The static instance of this class */
    private static final SocketStationCraftingManager instance = new SocketStationCraftingManager();
     ...
     */
    public static final SocketStationCraftingManager getInstance()
    {
        /** The static instance of this class */
        return instance;
    }

    private SocketStationCraftingManager()
    {
    ...
    public SocketStationShapedRecipes addRecipe(ItemStack p_92103_1_, Object ... p_92103_2_)
    {
        String s = "";
        int i = 0;
        int j = 0;
        ...
        SocketStationShapedRecipes shapedrecipes = new SocketStationShapedRecipes(j, k, aitemstack, p_92103_1_);
